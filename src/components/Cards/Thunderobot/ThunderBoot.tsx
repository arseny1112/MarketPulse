import styles from './Thunderobot.module.css'
import globalStyles from '../../../index.module.css'
import ThunderobotImg from '../../../assets/imgs/Thunderobot.png'
import {useCart} from '../../../contexts/CartContext'
import { useState } from 'react';
import { useFavorites } from '../../../contexts/FavoritesContext';

export function Thunderobot(){
    ...
    const product = {
        id: 5, 
        name: "Монитор Thunderobot", 
        description: 'Монитор игровой Thunderobot 24.5"/IPS/1920x1080/180Гц/',
        image: ThunderobotImg,  
        newPrice: 12999,
        price: 16999
    }
